...
const categories = ["Geral", "Novidades", "Pedidos", "Transações"];
...
export default function Page() {
  ...
  if (tickers) {
    todayBrl = tickers[tickers.length - 1].price * 5.71;
  }

  const animatedText = useAnimatedProps(() => {
    const brl = state.y.price.value.value * 5.71;
    return {
      text: `${brl.toLocaleString("pt-BR", {
        style: "currency",
        currency: "BRL",
      })}`,
      defaultValue: "",
                ...
                <>
                  ...
                  <CartesianChart
                    ...
                    axisOptions={{
                      ...
                      formatYLabel: (v) => `${v} R$`,
                      formatXLabel: (ms) =>
                        format(new Date(ms), "MM/yy", { locale: ptBR }),
                    }}
                    data={tickers!}
                    xKey="timestamp"
                    yKeys={["price"]}
